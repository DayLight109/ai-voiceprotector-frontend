...
export default function FamilyRecordingsPage() {
  return <RecordingsPage role="family-admin" />;
}
      ...
      <div className="grid grid-cols-12 gap-5">
        <div className="col-span-12 lg:col-span-8 panel p-6">
          ...
          <DataTable<Recording>
            ...
            columns={[
              ...
              { key: "size", label: "大小", align: "right", render: (r) => <span className="font-mono text-[11px] text-ink-soft font-bold">{r.size}</span> },
              {
                key: "verdict", label: "判决", render: (r) => {
                  ...
                  return <span className="font-mono text-[10px] uppercase tracking-[0.14em] px-2 py-1 rounded-full font-bold" style={{ background: m[r.verdict].bg, color: m[r.verdict].fg }}>{r.verdict}</span>;
                }
              },
        ...
        <aside className="col-span-12 lg:col-span-4 space-y-4">
          ...
          <div className="panel p-6" style={{ background: "var(--mint-soft)" }}>
            <div className="font-mono text-[10px] uppercase tracking-[0.14em] font-bold text-mint-deep mb-1">PRIVACY</div>
            <div className="text-[12px] font-semibold text-mint-deep leading-[1.7]">
